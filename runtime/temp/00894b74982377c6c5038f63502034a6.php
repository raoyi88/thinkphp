<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"D:\phpStudy\WWW\thinkphp\public/../application/admin/view/default/renzheng\index.html";i:1534086437;s:82:"D:\phpStudy\WWW\thinkphp\public/../application/admin/view/default/public\base.html";i:1496373782;s:87:"D:\phpStudy\WWW\thinkphp\public/../application/admin/view/default/article\sidemenu.html";i:1534081467;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div id="subnav" class="subnav">
 ...
 <h3>
 	...
 	<ul class="side-sub-menu <?php if(!in_array((request()->action()), explode(',',"mydocument,draftbox,examine"))): ?>subnav-off<?php endif; ?>">
		...
		<li <?php if(request()->action() == 'examine'): ?>class="examine"<?php endif; ?>><a class="item" href="<?php echo url('renzheng/index'); ?>">待审核</a></li>
		<?php endif; if($show_examine == '1'): ?>
...
<div class="data-table table-striped">
    <table class="">
        ...
        <tr>
            ...
            <td><?php echo $list['house']; ?></td>
            <?php if($list['relation']==1): ?>
            <td>本人</td>
            <?php endif; if($list['relation']==2): ?>
            <td>家属</td>
            <?php endif; if($list['relation']==3): ?>
            <td>租客</td>
            <?php endif; ?>
            <td><?php echo $list['tel']; ?></td>
            <td><?php echo $list['card_id']; ?></td>
            <td><a href="<?php echo url('changestatus?id='.$list['id']); ?>" class="btn btn-primary">通过审核</a>
                <a href="<?php echo url('Article/setStatus?status=-1&ids='.$vo['id']); ?>" class="btn btn-danger">删除</a>
            </td>
        </tr>
        <?php endforeach; endif; else: echo "" ;endif; ?>
        </tbody>
