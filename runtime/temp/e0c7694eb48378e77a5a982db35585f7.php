<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"D:\phpStudy\WWW\thinkphp\public/../application/home/view/default/zushou\index.html";i:1534085281;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid">
        ...
        <div class="bs-example bs-example-tabs" data-example-id="togglable-tabs">
            <ul id="myTabs" class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active"><a href="#myTabContent" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">租</a></li>
                        ...
                        <div class="col-xs-6 col-md-4">
                            <div class="thumbnail">
                                ...
                                <div class="caption">
                                    ...
                                    <p class="zushouInfo"><?php echo $list['content']; ?></p>
                                    <p class="text-danger"><?php echo $list['price']; ?>元/月</p>
                                    <p><a href="<?php echo url('show?id='.$list['id']); ?>" class="btn btn-danger zushouBtn">详细信息</a> </p>
                                </div>
                            </div>
                        </div>
