<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"D:\phpStudy\WWW\thinkphp\public/../application/admin/view/default/activity\show.html";i:1533955481;s:82:"D:\phpStudy\WWW\thinkphp\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="data-table table-striped">
    <table>
        ...
        <tr><td><?php echo $list['id']; ?></td></tr>
        <tr><td><h3>活动标题</h3></td></tr>
        <tr><td><?php echo $list['title']; ?></td></tr>
        <tr><td><h3>活动内容</h3></td></tr>
        <tr><td><?php echo $list['content']; ?></td></tr>
        <tr><td><h3>开始时间</h3></td></tr>
        <tr><td><?php echo date('Y-m-d',$list['start_time']); ?></td></tr>
        <tr><td><h3>结束时间</h3></td></tr>
        <tr><td><?php echo date('Y-m-d',$list['end_time']); ?></td></tr>
        <tr><td><h3>限制人数</h3></td></tr>
        <tr><td><?php echo $list['num']; ?></td></tr>
    </table>
</div>
