<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:93:"D:\phpStudy\WWW\thinkphp\public/../application/home/view/default/article\document\detail.html";i:1496373782;s:81:"D:\phpStudy\WWW\thinkphp\public/../application/home/view/default/base\common.html";i:1496373782;s:78:"D:\phpStudy\WWW\thinkphp\public/../application/home/view/default/base\var.html";i:1496373782;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="UTF-8">
		...
		<div class="container">
			...
			<p>
				<span  class="pull-left">
					...
					<span> 发表于 <?php echo date('Y-m-d H:i:s',$info['create_time']); ?></span>
				</span>
				<span class="pull-right">
                    ...
                    <?php endif; $next = model('Document')->next($info); if(!(empty($next) || (($next instanceof \think\Collection || $next instanceof \think\Paginator ) && $next->isEmpty()))): ?>
                        <a href="<?php echo url('',array('id'=>$next['id'])); ?>">下一篇</a>
                    <?php endif; ?>
				</span>
			</p>
		</div>
...
================================================== -->
    <div class="span3 bs-docs-sidebar">
        <ul class="nav nav-list bs-docs-sidenav">
            <li>
                <a href="<?php echo url('File/download?id='.$info['id']); ?>" class="btn btn-primary btn-block btn-large">立即下载</a>
            </li>
        </ul>
        <ul class="nav nav-list bs-docs-sidenav">
            <?php echo widget('Category/lists', array($category['id'], ACTION_NAME == 'index')); ?>
        </ul>
    </div>
