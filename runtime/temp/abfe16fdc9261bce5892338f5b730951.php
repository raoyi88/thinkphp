<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"D:\phpStudy\WWW\thinkphp\public/../application/admin/view/default/repair\create.html";i:1533720715;s:82:"D:\phpStudy\WWW\thinkphp\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<form action="<?php echo url('add'); ?>" method="post" class="form-horizontal">
    ...
    <div class="form-item">
        ...
        <div class="controls">
            <input type="tel" class="text input-large" name="tel">
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">时间<span class="check-tips"></span></label>
        <div class="controls">
            <input type="date" class="text input-large" name="time">
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">地点<span class="check-tips"></span></label>
        <div class="controls">
            <input type="text" class="text input-large" name="address">
        </div>
    </div>
    <div class="form-item">
