<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"D:\phpStudy\WWW\thinkphp\public/../application/admin/view/default/zushou\create.html";i:1534045659;s:82:"D:\phpStudy\WWW\thinkphp\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<h2>添加租售信息</h2>
<form action="<?php echo url('add'); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
    <div class="form-item">
        <label class="item-label">所属</label>
    ...
    <div class="form-item">
        ...
        <div class="controls">
            <input type="number" class="text input-large" name="price">
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">联系人<span class="check-tips"></span></label>
        <div class="controls">
            <input type="text" name="name" class="text input-large">
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">联系电话<span class="check-tips"></span></label>
        <div class="controls">
            <input type="tel" name="tel" class="text input-large">
        </div>
    </div>
    <div class="form-item">
