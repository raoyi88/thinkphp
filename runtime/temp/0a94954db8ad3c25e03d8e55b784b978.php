<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"D:\phpStudy\WWW\thinkphp\public/../application/admin/view/default/repair\edit.html";i:1533722722;s:82:"D:\phpStudy\WWW\thinkphp\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<form action="<?php echo url('update'); ?>" method="post" class="form-horizontal">
    <div class="form-item">
        <label class="item-label">报修简介<span class="check-tips"></span></label>
        <div class="controls">
            <input type="text" class="text input-large" name="title" value="<?php echo $repair['title']; ?>">
        </div>
    </div>
            <input type="hidden" class="text input-large" name="id" value="<?php echo $repair['id']; ?>">
    <div class="form-item">
        <label class="item-label">姓名<span class="check-tips"></span></label>
        <div class="controls">
            <input type="text" class="text input-large" name="name" value="<?php echo $repair['name']; ?>">
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">电话<span class="check-tips"></span></label>
        <div class="controls">
            <input type="tel" class="text input-large" name="tel" value="<?php echo $repair['tel']; ?>">
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">时间<span class="check-tips"></span></label>
        <div class="controls">
            <input type="date" class="text input-large" name="time" value="<?php echo date('Y-m-d',$repair['create_time']); ?>">
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">地点<span class="check-tips"></span></label>
        <div class="controls">
            <input type="text" class="text input-large" name="address" value="<?php echo $repair['address']; ?>">
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">详情<span class="check-tips"></span></label>
        <div class="controls">
            <textarea name="content" id="" cols="30" rows="10"><?php echo $repair['content']; ?></textarea>
        </div>
    </div>
    <div class="form-item">
