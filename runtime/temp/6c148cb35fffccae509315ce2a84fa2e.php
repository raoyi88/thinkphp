<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"D:\phpStudy\WWW\thinkphp\public/../application/admin/view/default/activity\edit.html";i:1533900389;s:82:"D:\phpStudy\WWW\thinkphp\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<form action="<?php echo url('update'); ?>" method="post" class="form-horizontal">
    <div class="form-item">
        <label class="item-label">活动简介<span class="check-tips"></span></label>
        <div class="controls">
            <input type="text" class="text input-large" name="title" value="<?php echo $activity['title']; ?>">
        </div>
    </div>
    <input type="hidden" class="text input-large" name="id" value="<?php echo $activity['id']; ?>">
    <div class="form-item">
        <label class="item-label">详情<span class="check-tips"></span></label>
        <div class="controls">
            <textarea name="content" class="textarea" cols="30" style="width: 390px" rows="10"><?php echo $activity['content']; ?></textarea>
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">开始时间<span class="check-tips"></span></label>
        <div class="controls">
            <input type="date" class="text input-large" name="start_time" value="<?php echo date('Y-m-d',$activity['start_time']); ?>">
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">结束时间<span class="check-tips"></span></label>
        <div class="controls">
            <input type="date" class="text input-large" name="end_time" value="<?php echo date('Y-m-d',$activity['end_time']); ?>">
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">人数<span class="check-tips"></span></label>
        <div class="controls">
            <input type="number" class="text input-large" name="num" value="<?php echo $activity['num']; ?>">
        </div>
    </div>
    <div class="form-item">
