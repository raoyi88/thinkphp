...
//		$category = $this->category();
        ...
        $category=$document->where('category_id',43)->select();
...
//		$p = empty($p) ? 1 : $p;
		...
		/* 分类信息 */
//		$this->category($info['category_id']);
        //添加浏览量
//        $repair=Db::table('twothink_document')->where('id',$id)->find();
        Db::table('twothink_document')->where('id', $id)->setInc('view');
